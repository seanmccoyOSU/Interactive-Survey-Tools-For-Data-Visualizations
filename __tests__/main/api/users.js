...
describe("POST /users - registers user", () => {
    test("POST /users creates a new user in database, sends 201 status code and id", async () => {
    ...
    test("POST /users sends 400 status code and error on invalid input", async () => {
